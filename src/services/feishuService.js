 ...
 */
export async function getFeishuSchema(appToken, tableId) {
 ...
 */
export async function appendToFeishu(issues, appToken, tableId, fieldMapping = null) {
  ...
  // 获取字段结构
  const schema = await getFeishuSchema(appToken, tableId);
